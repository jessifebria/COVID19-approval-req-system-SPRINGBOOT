...
public class EmpController {
    ...
    @RequestMapping("/employee/answercovid/{user}")
    ...
    @RequestMapping("/employee/saveanswercovid/{user}")
    public String submit(@PathVariable(name = "user") String user, TempAnswer temp, Model model) throws ParseException {
        ...
        if (covidfinish == 1) {
            ...
            i = -1;
            hasilcovid = 0;
            return "redirect:/employee/answer/" + user;
        } else {
            return "redirect:/employee/answercovid/" + user;
        }
    }
    ...
    @RequestMapping("/employee/answerurgency/{user}")
    ...
    @RequestMapping("/employee/saveanswerurgency/{user}")
    public String submiturgency(@PathVariable(name = "user") String user, TempAnswer temp, Model model) throws ParseException {
        ...
        if (urgencyfinish == 1) {
            ...
            return "redirect:/employee/answerurgency/" + user;
        }
    }

    @RequestMapping("/employee/savenote/{user}")
